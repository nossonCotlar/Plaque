public class Theme {
  ...
  public void initElements() {
    elements = new Element[] {
      ...
      new Scroller("/resources/texts/bottomRight.txt", width / 1.41176, height / 1.6744, width / 4.8, height / 4.69565, config.getInt("bottomRightPanelTextSize") * width / 1920, .7, false), 
